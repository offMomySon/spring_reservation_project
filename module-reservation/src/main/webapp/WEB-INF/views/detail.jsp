...
<body>
                    ...
                    <div class="group_visual">
                        <div>
                            <div class="container_visual">
                                <ul class="visual_img detail_swipe container_visual">
                                </ul>
                            </div>
                            <div class="prev">
                                <div class="prev_inn">
                    ...
                    <div class="review_box">
                        ...
                        <div class="short_review_area">
                            <div class="grade_area">
                                ...
                                <strong class="text_value"> <span></span> <em class="total"></em> </strong>
    ...
    <script type="rv-template" id="visualItem">
        {{#each productImages}}
        <li class="item container_visual">
            <img alt="" class="img_thumb container_visual" src="http://34.122.84.61:8080/{{saveFileName}}">
            <span class="img_bg">aa</span>
                    ...
                    {{#each commentImages}}
                        <div class="thumb_area">
                            <a href="#" class="thumb" title="이미지 크게 보기">
                                <img width="90" height="90" class="img_vertical_top" src="http://34.122.84.61:8080/{{saveFileName}}" alt="리뷰이미지">
                            </a>
    ...
    <script src="../js/detail/htmlFactory.js"></script>
    <script src="../js/detail/productDsc.js"></script>
    <script src="../js/detail/productView.js"></script>
    <script src="../js/detail/userComment.js"></script>
    <script src="../js/detail/detailInfo.js"></script>

    <script>
        document.addEventListener("DOMContentLoaded", async() =>{
            var categoryId = document.location.search.split("=")[1];

            await PageBuilder.build(categoryId);
        });
    </script>
