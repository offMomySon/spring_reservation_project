...
<body>
            ...
            <div class="ct_wrap">
                ...
                <div class="section_booking_form">
                            ...
                            <form class="form_horizontal">
                                ...
                                <div class="inline_form"> <label class="label" for="tel"> <span
                                    ...
                                    <div class="inline_control">
                                        ...
                                        <div class="warning_msg warning_tel">형식이 틀렸거나 너무 짧아요</div>
                                    </div>
                                </div>
                                <div class="inline_form"> <label class="label" for="email">
                                    <span class="spr_book ico_nessasary">필수</span>
                                    <span>이메일</span> </label>
                                    <div class="inline_control">
                                        <input type="email" name="email" id="email"
                                            class="email" value="" placeholder="crong@codesquad.kr" maxlength="50">
                                        <div class="warning_msg warning_email">형식이 틀렸거나 너무 짧아요</div>
                                    </div>
                                </div>
                    ...
                    <div class="section_booking_agreement">
                        ...
                        <div class="agreement collectInform"> <span class="chk_txt_span"> <i class="spr_book ico_arr_ipc2"></i>
                                <span>개인정보 수집 및 이용 동의</span> </span>
                            <a class="btn_agreement collectInform"> <span class="btn_text">보기</span> <i
                        ...
                        <!-- [D] 약관 보기 클릭 시 agreement에 open 클래스 추가 -->
                        <div class="agreement offerInform"> <span class="chk_txt_span"> <i class="spr_book ico_arr_ipc2"></i>
                                <span>개인정보 제3자 제공 동의</span> </span>
                            <a class="btn_agreement offerInform"> <span class="btn_text">보기</span> <i
                                    class="fn fn-down2"></i> </a>
    ...
    <script type="rv-template" id="visualItem">
        <li class="item" style="width: 414px;"> <img alt="" class="img_thumb" src="http://localhost:8080/reservation/{{productImages.[0].saveFileName}}"> <span class="img_bg"></span>
    ...
    <script type="rv-template" id="productDscItem">
        <div class="store_details">
            ...
            <p class="dsc">
                {{#each productPrices}}
                    {{priceTypeName}} 타입 {{Price price}} <br>
                {{/each}}
            </p>
        </div>
    </script>
    ...
    <script type="rv-template" id="reservationItem">
        ...
        <div class="qty" id="qty_{{@index}}">
            <div class="count_control">
                <div class="clearfix">
                    <a class="btn_plus_minus btn_minus spr_book2 ico_minus3 disabled" id="{{@index}}" title="빼기">
                    </a>
                    <input type="tel" class="count_control_input disabled" value=0 readonly title="수량" data-product-price-id={{productPriceId}}>
                    <a class="btn_plus_minus btn_plus spr_book2 ico_plus3" id="{{@index}}" title="더하기">
                    </a>
                </div>  
                <div class="individual_price">
                    <span class="total_price" data-price={{price}}>0</span>
            ...
            <div class="qty_info_icon">
                ...
                <em class="product_dsc">?? ({{discountRate}}% 할인가)</em> 
            </div>
        </div>
        {{/each}}
    </script>
    ...
    <script src="../js/reservation/product.js"></script>
    <script src="../js/reservation/reservation.js"></script>

    <script>
        document.addEventListener('DOMContentLoaded', async () => {
            initPage();
            const productIns = Product.create();
            const rsvIns = Reservation.create();
        });
