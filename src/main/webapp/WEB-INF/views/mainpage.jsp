...
<meta name="viewport"
	content="width=device-width,initial-scale=1.2,maximum-scale=1,minimum-scale=1,user-scalable=no">
<title>네이버 예약</title>
...
<body>
		...
		<div class="event">
			...
			<div class="section_event_lst">
				<p class="event_lst_txt">
					바로 예매 가능한 행사가 <span class="pink product_count"
						data-current-product-count="0" data-total-product-count="0"></span>
					있습니다
				</p>
	...
	<script type="rv-template" id="contentItem">
        <li class="item">
    ...
    <li class="item" id="{{productId}}" style="background-image: url(http://localhost:8080/reservation/{{productImageUrl}}/);">
        <a href="#">
	...
	<script src="../js/mainpage/htmlFactory.js"></script>
	<script src="../js/mainpage/tab.js"></script>
	<script src="../js/mainpage/product.js"></script>
	<script src="../js/mainpage/promotion.js"></script>
	<script src="../js/mainpage/pageController.js"></script>
