...
public class ReservationSql {
	...
	public final static String SELECT_RSV_INFO_AT_RSVID = "SELECT id as reservation_info_id, product_id, display_info_id, reservation_name, reservation_tel, reservation_email, reservation_date, cancel_flag, create_date, modify_date FROM connectdb.reservation_info where id = :rsvId";
